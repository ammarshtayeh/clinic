export const BRAND = {
  ...
  adminPortal: {
    title: "بوابة المنصة",
    subtitle: "لإدارة Asnany — العيادات والاشتراكات",
  },
} as const;
...
export const MOCK_ACCOUNTS = {
  owner: { email: "ammar.shtayeh@gmail.com", password: "ammarking123", label: "مالك العيادة" },
  doctor: { email: "ammar.ammar@gmail.com", password: "ammarking123", label: "طبيب" },
  admin: { email: "ammar.shtayeh@gmail.com", password: "ammarking123", label: "مدير المنصة" },
} as const;
